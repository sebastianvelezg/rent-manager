      ...
      <div className="flex h-16 items-center gap-4 px-6">
        <div className="flex flex-1 items-center gap-4">
          <div className="relative w-full max-w-md">
            ...
            <Input
              type="search"
              placeholder="Search properties, renters, invoices..."
              className="pl-10"
            />
          </div>
        </div>
              ...
              <DropdownMenuItem>
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    David Ospina - Penthouse El Poblado - $5.5M vencido
                  </p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Roberto Sánchez reportó: Calentador no funciona
                  </p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Laura Martínez - Contrato vence en 10 meses
                  </p>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
